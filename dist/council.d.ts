...
export type CouncilToolCategory = "story_direction" | "character_accuracy" | "writing_quality" | "context" | "content" | "extension";
export type CouncilToolExecution = "llm" | "host" | "extension" | "mcp";
...
export declare const SIDECAR_DEFAULTS: SidecarConfig;
/** @deprecated Use `SIDECAR_DEFAULTS` instead. */
export declare const COUNCIL_SIDECAR_DEFAULTS: SidecarConfig;
export declare const COUNCIL_TOOLS_DEFAULTS: CouncilToolsSettings;
export declare const COUNCIL_SETTINGS_DEFAULTS: CouncilSettings;

 ...
 */
export type EntityTypeDTO = "character" | "location" | "item" | "faction" | "concept" | "event";
export type EntityStatusDTO = "active" | "inactive" | "deceased" | "destroyed" | "unknown";
export type MentionRoleDTO = "subject" | "object" | "present" | "referenced" | "absent";
export type RelationTypeDTO = "ally" | "enemy" | "lover" | "parent" | "child" | "sibling" | "mentor" | "rival" | "owns" | "member_of" | "located_in" | "fears" | "serves" | "custom";
export type RelationStatusDTO = "active" | "broken" | "dormant" | "former";
export type EmotionalTagDTO = "grief" | "joy" | "tension" | "dread" | "intimacy" | "betrayal" | "revelation" | "resolve" | "humor" | "melancholy" | "awe" | "fury";
export type NarrativeFlagDTO = "first_meeting" | "death" | "promise" | "confession" | "departure" | "transformation" | "battle" | "discovery" | "reunion" | "loss";
